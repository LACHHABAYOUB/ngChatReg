...
export class ChatService {
    ...
    public createChat(message: ChatMessage): void {
        this.http.post(this.putMessageApi, Object.assign({}, message, { timestamp: new Date() }))
            .toPromise().then(p => {
                this.callCloudChats(message.chatRoom);
            });
    }
